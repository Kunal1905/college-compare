...
type SeedCollegeDefinition = {
  ...
  overview: string;
  courseNames: string[];
  placement: SeedCollege["placement"];
...
const inferDuration = (courseName: string) => {
  if (courseName === "MBBS") {
    return "5.5 Years";
  }
...
const inferCourseFee = (baseFees: number, courseName: string, index: number) => {
  let multiplier = 1;
...
const clampRating = (rating: number) =>
  Math.max(3.5, Math.min(5, Number(rating.toFixed(1))));

const collegeDefinitions: SeedCollegeDefinition[] = [
  {
    name: "IIT Bombay",
    slug: "iit-bombay",
    location: "Mumbai",
    ...
    overview:
      "A premier public engineering institute with standout research culture, exceptional CSE outcomes, and a deeply competitive student ecosystem.",
    courseNames: [
  ...
  },
  {
    ...
    overview:
      "Known for cutting-edge labs, high-impact research, and top-tier placements across software, consulting, and core engineering roles.",
    courseNames: [
      "B.Tech Computer Science",
  ...
  },
  {
    ...
    overview:
      "A research-forward campus celebrated for strong engineering fundamentals, innovation support, and elite hiring outcomes.",
    courseNames: [
      "B.Tech Computer Science",
      "B.Tech Data Science",
      "B.Tech Electrical Engineering",
  ...
  },
  {
    ...
    overview:
      "A large private university with strong infrastructure, active coding culture, and wide access to internships and campus hiring.",
    courseNames: [
      "B.Tech Computer Science",
      "B.Tech AI & ML",
  ...
  },
  {
    ...
    overview:
      "One of Maharashtra's most respected engineering campuses, offering strong value, legacy, and dependable placements.",
    courseNames: [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A student-friendly engineering school with strong campus life, global exposure, and stable placement outcomes across multiple tech tracks.",
    courseNames: [
      "B.Tech Computer Science",
      "B.Tech AI & ML",
      "B.Tech Mechatronics",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A large multidisciplinary university with strong intake diversity, growing tech programs, and visible recruiter participation.",
    courseNames: [
      "B.Tech Computer Science",
      "B.Tech AI & ML",
      "B.Tech Electronics",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1200&q=80",
    overview:
      "India's flagship management school known for case-based learning, elite consulting placements, and a powerful alumni network.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A highly selective MBA destination with top corporate partnerships, a polished campus experience, and outstanding final placements.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1568792923760-d70635a89fdc?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A top-tier business school especially respected for finance, analytics, and high-value consulting placements.",
    courseNames: ["MBA", "MBA Finance", "PGDM"],
    placement: {
      averagePackage: 34,
      highestPackage: 115,
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A reputed management institute with standout HR and business management programs and very strong placement consistency.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A Mumbai-based management institute valued for industry immersion, strong finance and marketing outcomes, and a collaborative learning model.",
  ...
  },
  {
    ...
    overview:
      "India's benchmark public medical institution, recognised for clinical training depth, research output, and national-level prestige.",
  ...
  },
  {
    ...
    overview:
      "A respected medical college known for patient-centric training, outstanding clinical exposure, and a deeply service-oriented culture.",
    courseNames: ["MBBS", "B.Sc Nursing", "MD"],
    placement: {
      averagePackage: 10,
      highestPackage: 28,
  ...
  },
  {
    ...
    overview:
      "A disciplined and respected medical college combining strong academics with service-focused professional development.",
    courseNames: ["MBBS", "B.Sc Nursing", "MD"],
    placement: {
      averagePackage: 11,
      highestPackage: 25,
  ...
  },
  {
    ...
    overview:
      "A top national law university with strong academics, moot court culture, and elite corporate law and policy opportunities.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A highly regarded law campus with strong litigation, corporate law, and public policy exposure backed by a focused academic environment.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A popular private law school with strong student activities, strong Pune industry access, and consistent internship opportunities.",
  ...
  },
  {
    ...
    overview:
      "A design-first institution with strong studio culture, brand visibility, and solid outcomes across digital, product, and communication design.",
  ...
  },
  {
    ...
    overview:
      "A strong choice for fashion and textile design students looking for established industry connections and brand visibility.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A private design institute with hands-on project work, interdisciplinary exposure, and a student portfolio-driven learning model.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&w=1200&q=80",
    overview:
      "One of India's most sought-after commerce colleges, with strong academics, finance-oriented culture, and excellent brand equity.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A legacy institution with strong academics, a vibrant campus culture, and good undergraduate outcomes across commerce and economics.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1568792923760-d70635a89fdc?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A multidisciplinary university with polished student systems, strong undergraduate programs, and dependable placement support.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A highly specialized technology institute known for deep computer science rigor, strong research output, and elite software placements.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A focused technology campus with strong software, AI, and analytics outcomes backed by Bangalore's tech ecosystem.",
    courseNames: [
      "B.Tech Computer Science",
      "M.Tech AI",
      "M.Tech Data Science",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&w=1200&q=80",
    overview:
      "An ICT-focused campus with a strong coding ecosystem, thoughtful academics, and dependable placement results.",
    courseNames: [
      "B.Tech ICT",
      "B.Tech Computer Science",
      "M.Tech Data Science",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A broad public university system with strong undergraduate commerce, economics, and computer science programs across multiple colleges.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1568792923760-d70635a89fdc?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A large public university with strong city access, broad undergraduate options, and good affordability for commerce and CS students.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A broad private university with strong infrastructure, wide program diversity, and visible placement support across disciplines.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A research-led IIT with excellent technical depth, high-quality faculty, and strong outcomes in core engineering and software roles.",
    courseNames: [
      "B.Tech Computer Science",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A globally visible business school with strong executive-facing pedagogy, premium recruiter access, and standout leadership outcomes.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1571260899304-425eee4c7efc?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A respected public medical institution with strong hospital exposure, robust training systems, and a long-standing clinical reputation.",
    courseNames: ["MBBS", "B.Sc Nursing", "MD"],
    placement: {
      averagePackage: 9.8,
      highestPackage: 24,
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A leading national law university with a strong reputation in corporate law, moots, and competitive internships.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A design-focused private institution with strong industry-led curriculum and practical portfolio development.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A respected autonomous college known for strong undergraduate teaching, vibrant student life, and solid placements in commerce and computer applications.",
    courseNames: ["B.Com", "BBA", "BCA"],
    placement: {
      averagePackage: 5.8,
      highestPackage: 15,
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1568792923760-d70635a89fdc?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A highly regarded engineering college in Tamil Nadu with strong academic discipline and reliable technical placements.",
    courseNames: [
      "B.Tech Computer Science",
      "B.Tech Electrical Engineering",
      "B.Tech Mechanical Engineering",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A strong private management destination in Mumbai with corporate exposure, polished infrastructure, and wide recruiter participation.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1571260899304-425eee4c7efc?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A top public medical institute known for excellent clinical exposure, affordability, and strong academic systems.",
    courseNames: ["MBBS", "B.Sc Nursing", "MD"],
    placement: {
      averagePackage: 10.8,
      highestPackage: 27,
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1200&q=80",
    overview:
      "A fashion and design institute with strong city exposure, brand visibility, and industry-linked design projects.",
...
const collegeSeedData: SeedCollege[] = collegeDefinitions.map((college, index) => {
...
const seed = async () => {
  ...
  await db.transaction(async (tx) => {
    ...
    if (existingDemoUser) {
      await tx
        ...
        .where(eq(users.id, existingDemoUser.id));
    } else {
  ...
  console.log(
    `Seed completed successfully with ${collegeSeedData.length} colleges and 1 demo user.`
  );
};
